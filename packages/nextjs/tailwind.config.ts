...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "cyber-gradient":
          "linear-gradient(to right, rgb(3,7,18), rgb(24,29,49))",
      ...
      keyframes: {
        ...
        "neon-pulse": {
          "0%, 100%": {
            boxShadow: "0 0 5px #4DEEEA, 0 0 10px #4DEEEA, 0 0 15px #4DEEEA",
          },
          "50%": {
            boxShadow: "0 0 10px #F000FF, 0 0 20px #F000FF, 0 0 30px #F000FF",
          },
        },
      },
      animation: {
